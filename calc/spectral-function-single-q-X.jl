...
Phunky.write_to_file(
    "data/specfunc/linewidths-extended-21x21x21-300K-X.data",
    lineshift_container.linewidths_extended,
)
Phunky.write_to_file(
    "data/specfunc/lineshifts-21x21x21-300K-X.data",
    lineshift_container.lineshifts,
)
Phunky.write_to_file(
    "data/specfunc/contfreqs-extended-21x21x21-300K-X.data",
