...
Phunky.write_to_file(
    "data/specfunc/linewidths-extended-18x18x18-300K-Gamma.data",
    lineshift_container.linewidths_extended,
)
Phunky.write_to_file(
    "data/specfunc/lineshifts-18x18x18-300K-Gamma.data",
    lineshift_container.lineshifts,
)
Phunky.write_to_file(
    "data/specfunc/contfreqs-extended-18x18x18-300K-Gamma.data",
